---
title: Taylor Shellfish Sept 2025 resazurin family screening - mean family size normalization 
author: "AS Huffmyer"
date: '2025'
output:
...
This script analyzes resazurin assays on Taylor Shellfish seed. This script uses mean family size normalization
...
```{r}
metrics%>%
  write_csv("taylor-shellfish-sept2025/output/taylor_screening_metrics.csv")
```
